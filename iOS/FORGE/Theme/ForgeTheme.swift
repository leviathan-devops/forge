...
extension SwiftUI.Color {
    ...
    /// Forge fire orange accent — the primary accent. Hex E04307.
    static let forgeAccent = SwiftUI.Color(red: 0xE0/255, green: 0x43/255, blue: 0x07/255)

    /// Bright forge orange — active/pressed/glow. Hex FF6B2C.
    static let forgeAccentBright = SwiftUI.Color(red: 0xFF/255, green: 0x6B/255, blue: 0x2C/255)

    /// Dim forge orange — borders at 20%. Hex 8A2E07.
    static let forgeAccentDim = SwiftUI.Color(red: 0x8A/255, green: 0x2E/255, blue: 0x07/255)
    ...
    /// Card stroke — accent dim at 20 % opacity.
    static let forgeBorder = forgeAccentDim.opacity(0.2)
}
...
extension UIColor {
    ...
    /// Forge fire orange accent as UIColor. Hex E04307.
    static let forgeAccent = UIColor(
        red: 0xE0/255, green: 0x43/255, blue: 0x07/255, alpha: 1.0
    )

    /// Bright forge orange as UIColor. Hex FF6B2C.
    static let forgeAccentBright = UIColor(
        red: 0xFF/255, green: 0x6B/255, blue: 0x2C/255, alpha: 1.0
    )

    /// Dim forge orange as UIColor. Hex 8A2E07.
    static let forgeAccentDim = UIColor(
        red: 0x8A/255, green: 0x2E/255, blue: 0x07/255, alpha: 1.0
    )
    ...
    /// Card stroke as UIColor (accent dim @ 20 %).
    static let forgeBorder = UIColor(
        red: 0x8A/255, green: 0x2E/255, blue: 0x07/255, alpha: 0.2
    )
}
...
struct ForgeTheme {
    ...
    static let ansiColors: [SwiftTerm.Color] = [
        ...
        SwiftTerm.Color(red: 0xE0, green: 0x43, blue: 0x07), // 4  Forge orange accent
        SwiftTerm.Color(red: 0xFF, green: 0x79, blue: 0xC6), // 5  Magenta
        SwiftTerm.Color(red: 0xFF, green: 0x6B, blue: 0x2C), // 6  Bright forge orange
        ...
        SwiftTerm.Color(red: 0xFF, green: 0x8C, blue: 0x4A), // 12 Bright forge orange
        SwiftTerm.Color(red: 0xFF, green: 0x92, blue: 0xD0), // 13 Bright magenta
        SwiftTerm.Color(red: 0xFF, green: 0xB8, blue: 0x6C), // 14 Bright forge orange light
        SwiftTerm.Color(red: 0xFF, green: 0xFF, blue: 0xFF), // 15 Bright white
    ]

    /// The default cursor color (forge orange).
    static let cursorColor = SwiftTerm.Color(red: 0xE0, green: 0x43, blue: 0x07)

    /// The default selection background (orange at low alpha).
    static let selectionColor = UIColor(red: 0xE0/255, green: 0x43/255, blue: 0x07/255, alpha: 0.2)
...
extension View {
    ...
    /// Apply FORGE accent glow (forge orange shadow).
